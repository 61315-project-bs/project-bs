...
public class ResourceManager : Singleton<ResourceManager>
{
  ...
  public T Load<T>(string path) where T : Object
  {
    ...
    catch (System.Exception ex)
    {
      ...
      Debug.Log($"{ex.Message}, {ex.StackTrace}, {sceneName}");
      return null;
    }
  }
  ...
  public Sprite LoadSprite(string spriteSheetPath, string spriteID)
  {
    try
    {
      ...
      if (sprites.Length == 0)
      {
        throw new System.Exception($"ResourceManager::LoadSprite() Failed to load sprite sheet: {spriteSheetPath}");
      }
      ...
      {
        throw new System.Exception($"ResourceManager::LoadSprite() Sprite with ID {spriteID} not found in sheet: {spriteSheetPath}");
      }
    }
    catch (System.Exception ex)
    {
